        ...
        <>
            <footer className="bg-slate-50 text-white">
                <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-7">
                    <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5 text-yellow-400 font-bold"><span className="text-black">Learn</span>ENG</h1>
                    <div className="space-y-3">
                        ...
                        <button className="bg-yellow-500 hover:bg-teal-600kk duration-300 px-5 py-2.5 font-[Poppins] font-semibold hover:font-bold hover:bg-yellow-600 rounded-md text-white md:w-auto w-full">
                            Send 
                        </button>
                    </div>
                </div>
